...
//        List<FunctionView.Element> elems = new ArrayList<>();
//        elems.add(new FunctionView.Element(12f,6f,"周一"));
//        elems.add(new FunctionView.Element(10f,8f,"周二"));
//        elems.add(new FunctionView.Element(20f,6f,"周三"));
//        elems.add(new FunctionView.Element(11f,9f,"周四"));
//        fv.setElements(elems);
//        fv.startAnimation();
    }
}
